...
l3 = groupl['TOTAL'].agg([np.sum])
groupl2 = l1.groupby('DATE')
l4 = groupl2['TOTAL'].agg([np.sum])
groupl3 = l1.groupby('WEEK NUMBER')
l5 = groupl3['TOTAL'].agg([np.sum])
groupl4 = l1.groupby('DAY')
l6 = groupl4['TOTAL'].agg([np.sum])
...
z1 = z1.to_frame()
z2 = z1['ITEM']['WEEK 1'][0:5]
z3 = z1['ITEM']['WEEK 2'][0:5]
z4 = z1['ITEM']['WEEK 3'][0:5]
z5 = z1['ITEM']['WEEK 4'][0:5]
z6 = z1['ITEM']['WEEK 5'][0:5]

z7 = data[['DAY' , 'ITEM','FOOD TYPE']]
groupz2 = z7.groupby('DAY')
z8 = groupz2['ITEM'].value_counts()
z8 = z8.to_frame()
z9 = z8['ITEM']['MONDAY'][0:5]
z10 = z8['ITEM']['TUESDAY'][0:5]
z11 = z8['ITEM']['WEDNESDAY'][0:5]
z12 = z8['ITEM']['THURSDAY'][0:5]
z13 = z8['ITEM']['FRIDAY'][0:5]
z14 = z8['ITEM']['SATURDAY'][0:5]
z15 = z8['ITEM']['SUNDAY'][0:5]
